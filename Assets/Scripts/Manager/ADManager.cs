...
public class ADManager : MonoBehaviour
{
...
#if UNITY_ANDROID
        string appId = "ca-app-pub-1364411016051657~1552104293";
#elif UNITY_IPHONE
    ...
    public enum ADType
    {
        Banner, Interstitial, RewardedAd
    }

    public void ADCallByType(int type)
    {
        switch ((ADType)type)
        {
            case ADType.Banner:
            ...
            default:
                {
                    Debug.Log("ADtype is wrong. \n Banner = 0, Interstitial = 1, RewardedAd = 2");
...
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-1364411016051657/5929514760";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-1364411016051657/5929514760";
#else
    ...
    private void RequestInterstitial()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-1364411016051657/8939424126";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-1364411016051657/8939424126";
#else
        string adUnitId = "unexpected_platform";
    ...
    private void CreateAndLoadRewardedAd()
    {
        ...
        string adUnitId = "unused";
#elif UNITY_ANDROID
        string adUnitId = "ca-app-pub-1364411016051657/8268150917";
#elif UNITY_IPHONE
        string adUnitId = "ca-app-pub-1364411016051657/8268150917";
#else
        string adUnitId = "unexpected_platform";
